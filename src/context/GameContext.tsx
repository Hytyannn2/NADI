...
const DEFAULT_BADGES: Badge[] = [
  // ── Civic Reporting ──
  { id: 'civic_hero', name: 'Civic Hero', description: 'Submit 10 civic reports', icon: '', condition: '10 reports', unlocked: false },
  { id: 'report_rookie', name: 'Report Rookie', description: 'Submit your first report', icon: '', condition: '1 report', unlocked: false },
  { id: 'pothole_hunter', name: 'Pothole Hunter', description: 'Report 5 road issues', icon: '', condition: '5 road reports', unlocked: false },
  ...
  { id: 'voice_of_reason', name: 'Voice of Reason', description: 'Use Suara voice reporting 10 times', icon: '', condition: '10 voice reports', unlocked: false },
  ...
  { id: 'storm_chaser', name: 'Storm Chaser', description: 'Check flood status 10 times', icon: '', condition: '10 flood checks', unlocked: false },
  ...
  { id: 'data_nerd', name: 'Data Nerd', description: 'View the Civic Heatmap 5 times', icon: '', condition: '5 heatmap views', unlocked: false },
  ...
  { id: 'level_5', name: 'Pejuang', description: 'Reach Level 5', icon: '', condition: 'level 5', unlocked: false },
  { id: 'level_10', name: 'Pahlawan', description: 'Reach Level 10', icon: '', condition: 'level 10', unlocked: false },
  ...
  { id: 'crs_800', name: 'Exemplary Warga', description: 'Reach 800 CRS score', icon: '', condition: 'CRS 800', unlocked: false },
];
