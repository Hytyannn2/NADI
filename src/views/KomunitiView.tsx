                ...
                {isLoading ? (
                    ...
                    <motion.div key="kerja" initial={{ opacity: 0, x: -10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 10 }} className="space-y-3">
                        ...
                        {filteredJobs.length === 0 ? (
                            <div className="text-center py-12 px-4 rounded-2xl border border-dashed border-zinc-800 bg-[#0D0D10]/80">
                                <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto mb-3 text-zinc-400">
                                    <Briefcase className="w-6 h-6 text-[#C5A367]" />
                                </div>
                                ...
                                <button
                                    onClick={() => setShowAddModal(true)}
                                    className="px-4 py-2.5 rounded-xl text-xs font-bold text-black bg-[#C5A367] inline-flex items-center gap-1.5 transition-all shadow-md active:scale-95 hover:brightness-110"
                                >
                            ...
                            filteredJobs.map((job, i) => (
                                <motion.div
                                    ...
                                    className="rounded-2xl p-4 relative overflow-hidden border transition-all hover:border-zinc-700"
                                ...
                                >
                                    ...
                                    <p className="text-xs mb-3 leading-relaxed text-zinc-300 whitespace-pre-line">{job.description}</p>
                                    ...
                                    <div className="flex items-center gap-2">
                                        {job.applyUrl && (
                                            <a
                                                ...
                                                className="flex-1 py-2.5 px-3 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all shadow-md active:scale-95 hover:brightness-110 bg-[#C5A367] text-black"
                                            >
                                                <ExternalLink className="w-3.5 h-3.5" /> Buka Laman Permohonan
                                            </a>
                                        )}
                                        {job.whatsapp && (
                                            <button
                                                ...
                                                className="py-2.5 px-4 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all shadow-md active:scale-95 hover:opacity-90 bg-[#25D366] text-white shrink-0"
                                            >
                    ...
                    <motion.div key="niaga" initial={{ opacity: 0, x: 10 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -10 }} className="space-y-3">
                        ...
                        {filteredVendors.length === 0 ? (
                            <div className="text-center py-12 px-4 rounded-2xl border border-dashed border-zinc-800 bg-[#0D0D10]/80">
                                <div className="w-12 h-12 rounded-2xl bg-zinc-900 border border-zinc-800 flex items-center justify-center mx-auto mb-3 text-zinc-400">
                                    <ShoppingBag className="w-6 h-6 text-[#C5A367]" />
                                </div>
                            ...
                            filteredVendors.map((vendor, i) => (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3 flex-wrap mb-3 text-zinc-400">
                                    ...
                                    {vendor.whatsapp && (
                                        <button
                                            ...
                                            className="w-full py-2.5 rounded-xl text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-all hover:opacity-90 bg-[#25D366] text-white shadow-md active:scale-95"
                                        >
                ...
                {showAddModal && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
                        <motion.div
                            ...
                            className="bg-[#0A0A0C] border border-zinc-800 rounded-3xl p-6 max-w-md w-full shadow-2xl relative text-white max-h-[90vh] overflow-y-auto no-scrollbar"
                        >
