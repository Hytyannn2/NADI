    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="absolute top-[118px] left-5 right-5 z-50 rounded-2xl shadow-2xl overflow-hidden"
          style={{ background: 'var(--bg-card)', border: '1px solid var(--border-default)', boxShadow: 'var(--shadow-lg)' }}
        >
          {/* Mascot Header */}
          <div className="px-4 py-4 flex items-center gap-4" style={{ borderBottom: '1px solid var(--border-default)' }}>
            <motion.div
              animate={{ y: [0, -4, 0] }}
