...
const cspHeader = [
  ...
  "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.open-meteo.com https://publicinfobanjir.water.gov.my https://translate.googleapis.com https://api.bigdatacloud.net https://*.basemaps.cartocdn.com https://basemaps.cartocdn.com https://*.openstreetmap.org https://services.arcgisonline.com https://server.arcgisonline.com https://*.google.com https://mt0.google.com https://mt1.google.com https://mt2.google.com https://mt3.google.com",
  "frame-src 'self'",
].join('; ');
